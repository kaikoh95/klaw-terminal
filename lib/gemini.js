...
function buildAnalysisPrompt(marketData, technicals, multiTimeframe = null) {
  ...
  const { movingAverages, vwma, rsi, mfi, macd, stochastic, bollingerBands, vwap, obv, obvDivergence, cmf, atr, psar, superTrend, adx, fibonacci, nearestFib, supportResistance, trend, candlestickPatterns, priceActionPatterns, volumeProfile, heikinAshi, ichimoku, volumeDelta } = technicals;
