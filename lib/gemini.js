...
function buildAnalysisPrompt(marketData, technicals) {
  ...
  const { movingAverages, rsi, mfi, macd, stochastic, bollingerBands, vwap, obv, obvDivergence, cmf, atr, adx, fibonacci, nearestFib, supportResistance, trend, candlestickPatterns, volumeProfile, heikinAshi, ichimoku } = technicals;
...
• Multi-System Confluence (Ichimoku + VP POC + Fib + Pattern + HA): Ultra setup (+4-5)
