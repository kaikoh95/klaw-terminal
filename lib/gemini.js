...
function buildAnalysisPrompt(marketData, technicals) {
  ...
  const { movingAverages, rsi, mfi, macd, stochastic, bollingerBands, vwap, obv, obvDivergence, cmf, atr, adx, fibonacci, nearestFib, supportResistance, trend, candlestickPatterns, volumeProfile, heikinAshi, ichimoku, volumeDelta } = technicals;
