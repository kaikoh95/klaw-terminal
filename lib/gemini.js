...
function buildAnalysisPrompt(marketData, technicals) {
  ...
  const { movingAverages, rsi, mfi, macd, stochastic, bollingerBands, vwap, obv, obvDivergence, atr, adx, fibonacci, nearestFib, supportResistance, trend, candlestickPatterns } = technicals;
...
- Candlestick pattern + Fibonacci level + Volume = Triple confluence (highest confidence)
