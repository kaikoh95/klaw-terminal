...
function buildAnalysisPrompt(marketData, technicals) {
  ...
  const { movingAverages, rsi, macd, stochastic, bollingerBands, vwap, obv, obvDivergence, atr, adx, fibonacci, nearestFib, supportResistance, trend, candlestickPatterns } = technicals;
